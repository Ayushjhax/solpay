...
async function post(req: NextApiRequest, res: NextApiResponse<PostData>) {
  ...
  const tree = new PublicKey("GA1ew3hihW8Xs6gpsxVnYLHNq3rgWpa3PMh9LKiq6K4D");
  ...
  const message = "Thank you for using ondc";
...
async function createMintCNFTInstruction(
  ...
  const collectionMint = new PublicKey(
    "GA1ew3hihW8Xs6gpsxVnYLHNq3rgWpa3PMh9LKiq6K4D"
  );
